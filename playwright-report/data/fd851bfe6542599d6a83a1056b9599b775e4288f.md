...
- Name: smoke-tests.spec.ts >> Phase 6 Critical Flows >> Flow 1: Load -> Edit -> Dirty -> Save -> Clean
- Location: e2e\smoke-tests.spec.ts:17:7
...
Locator: locator('[title="Unsaved changes"]').first()
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 20000ms
  - waiting for locator('[title="Unsaved changes"]').first()
