...
import { Plus, Layout, Trash2, Move, Box, Maximize2, Type, Layers } from 'lucide-react';
    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="space-y-4">
        {containers.map((container) => (
          <div key={container.id} className="p-4 bg-black/40 border border-outline/5 rounded-xs space-y-4 group hover:border-outline/20 transition-all">
            <div className="flex justify-between items-start">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-white/5 rounded-xs text-primary/40 group-hover:text-primary transition-colors">
                ...
                <div className="flex flex-col">
                  <input 
                    ...
                    onChange={(e) => onUpdate(container.id, { label: e.target.value })}
            ...
            <div className="pt-4 border-t border-outline/5 space-y-2">
               ...
               <p className="text-[6px] text-foreground/20 font-bold uppercase italic mt-1">
                 * If GLOBAL, container persists across all tabs. Otherwise, it only renders on the selected plane.
               </p>
            </div>
          </div>
        ))}
