  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/80 backdrop-blur-sm">
      <motion.div 
        ...
        className="w-full max-w-2xl bg-[#0a0a0a] border border-white/10 rounded-lg shadow-2xl overflow-hidden flex flex-col max-h-[80vh]"
      >
        {/* HEADER */}
        <div className="p-6 border-b border-white/5 bg-white/[0.02] flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-sm font-black uppercase tracking-[0.2em] text-white">Industrial Ingestion Wizard</h2>
              <p className="text-[9px] text-white/40 uppercase font-bold mt-0.5">OMEGA Era 7.1 • Asset Synchronization</p>
            </div>
          </div>
        ...
        <div className="p-6 border-t border-white/5 bg-white/[0.01] flex items-center justify-between">
          <button 
            onClick={onCancel}
            className="px-6 py-2 text-[10px] font-black uppercase text-white/40 hover:text-white transition-colors"
          >
            Abort Ingestion
          </button>
          <button 
            ...
            className="px-8 py-3 bg-primary text-black text-[11px] font-black uppercase tracking-widest rounded-xs hover:bg-primary/80 transition-all flex items-center gap-2 disabled:opacity-30 disabled:cursor-not-allowed shadow-[0_0_20px_rgba(0,240,255,0.2)]"
          >
